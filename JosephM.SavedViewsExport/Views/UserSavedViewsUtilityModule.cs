...
using JosephM.UserSavedObjectsUtility.Views.Clone;
using JosephM.UserSavedObjectsUtility.Views.Share;
using System.Linq;

namespace JosephM.UserSavedObjectsUtility.Views
{
    [MyDescription("Export, clone, and share, user saved views")]
    public class UserSavedViewsUtilityModule :
        ServiceRequestModule
            <UserSavedViewsUtilityDialog, UserSavedViewsUtilityService, UserSavedViewsUtilityRequest,
                UserSavedViewsUtilityResponse, UserSavedViewsUtilityResponseItem>
    {
