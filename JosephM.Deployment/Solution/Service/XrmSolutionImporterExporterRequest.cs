...
namespace JosephM.Xrm.ImportExporter.Service
{
    ...
    public class XrmSolutionImporterExporterRequest : ServiceRequestBase
    {
        ...
        [DisplayName("Select A Folder To Export The Files Into")]
        [RequiredProperty]
        ...
        [DisplayName("Select Saved Connection For The CRM Instance To Import Into")]
        [RequiredProperty]
        ...
        [DisplayName("Select A Folder To Include Exported Record XML Files In The Import (Optional)")]
