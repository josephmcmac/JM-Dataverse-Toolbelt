...
namespace JosephM.Record.Application.Fakes
{
    public class FakeRecordService : RecordService
    {
        ...
        {
            return GetFirst(FakeConstants.RecordType, FakeConstants.PrimaryField, FakeConstants.MainRecordName);
        }
            ...
            IDictionary<string, object> additionalFields)
        {
            ...
            entity.Id = id;
            entity.SetField(GetPrimaryKey(recordType), id, this);
            entity.SetField(GetPrimaryField(recordType), primaryField, this);
            ...
            return Get(entity.Type, Create(entity));
        }
        ...
        internal static IEnumerable<RecordMetadata> GetFakeRecordMetadata()
        {
            var recordMetadata = new RecordMetadata
            {
                ...
                DisplayCollectionName = "Fake Records",
                PrimaryKeyName = FakeConstants.Id,
            ...
            var recordMetadata2 = new RecordMetadata
            {
                ...
                DisplayCollectionName = "Fake Records 2",
                PrimaryKeyName = FakeConstants.Id2
            };
            return new[]
            {
        ...
        private static RecordMetadata CreateActivityPartyTypeMetadata()
        {
            return new RecordMetadata
            {
                ...
                DisplayCollectionName = FakeConstants.FakeActivityPartyType,
                PrimaryKeyName = FakeConstants.FakeActivityPartyTypeId,
                Fields = new FieldMetadata[]
                {
                    new StringFieldMetadata(FakeConstants.FakeActivityPartyTypeId, FakeConstants.FakeContactTypeId),
        ...
        private static RecordMetadata CreateContactTypeMetadata()
        {
            return new RecordMetadata
            {
                ...
                DisplayCollectionName = FakeConstants.FakeContactType,
                PrimaryKeyName = FakeConstants.FakeContactTypeId,
                IsActivityParticipant = true,
                Fields = new[]
                {
                    new StringFieldMetadata(FakeConstants.FakeContactTypeId, FakeConstants.FakeContactTypeId),
        ...
        private static RecordMetadata CreateFakeActivityTypeMetadata()
        {
            return new RecordMetadata
            {
                ...
                DisplayCollectionName = FakeConstants.FakeEmailType,
                PrimaryKeyName = FakeConstants.FakeEmailTypeId,
                IsActivityType = true,
                Fields = new FieldMetadata[]
                {
                    new StringFieldMetadata(FakeConstants.FakeEmailTypeId, FakeConstants.FakeEmailTypeId),
        ...
        private static RecordMetadata CreateFakePostTypeMetadata()
        {
            return new RecordMetadata
            {
                ...
                DisplayCollectionName = FakeConstants.FakePostType,
                PrimaryKeyName = FakeConstants.FakePostTypeId,
                Fields = new[]
                {
                    new StringFieldMetadata(FakeConstants.FakePostTypeId, FakeConstants.FakePostTypeId),
        ...
        internal static IEnumerable<FieldMetadata> GetFakeRecordFieldMetadata()
        {
            ...
            {
                new StringFieldMetadata(FakeConstants.Id, "Id"),
                ...
                new ComboBoxFieldMetadata(FakeConstants.ComboField, "An Combo"),
        ...
        internal static IEnumerable<FieldMetadata> GetFakeRecordFieldMetadata2()
        {
            return new FieldMetadata[]
            {
                new StringFieldMetadata(FakeConstants.Id2, "Id 2"),
