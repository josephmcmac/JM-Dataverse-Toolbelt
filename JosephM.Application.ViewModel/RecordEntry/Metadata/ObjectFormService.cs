        ...
        public override FormMetadata GetFormMetadata(string recordType, IRecordService recordService = null)
        {
            if (_formMetadata == null)
            {
                ...
                foreach (var section in fieldSections)
                {
                    ...
                    var newSection = new FormFieldSection(section.Name, otherSections[section.Name], section.DisplayLayout, section.Order, customFunctions: functions, displayLabel: section.DisplayLabel, isHiddenSection: section.IsHiddenSection);
                ...
                foreach (var property in propertyMetadata.Where(m => m.Readable || m.Writeable))
                {
                    ...
                    {
                        fieldMetadata.EditableFormWidth = editableWidthAttribue.Width;
                    }
