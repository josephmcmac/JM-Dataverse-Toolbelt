        ...
        public string ValueString
        {
            get
            {
                ...
                return IsEditable
                    ...
                    : Value.Value.ToString(string.Format("0.00{0}", "#".ReplicateString(RecordEntryViewModel.RecordService.GetFieldMetadata(FieldName, GetRecordType()).DecimalPrecision - 2)));
            }
            set
            {
                if (value == null)
