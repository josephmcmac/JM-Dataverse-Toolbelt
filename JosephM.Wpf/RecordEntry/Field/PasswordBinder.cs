...
namespace JosephM.Wpf.RecordEntry.Field
{
    public static class PasswordBinder
    {
        ...
        private static readonly DependencyProperty UpdatingPassword =
            DependencyProperty.RegisterAttached("UpdatingPassword", typeof (bool), typeof (PasswordBinder),
        ...
        private static void OnBoundPasswordChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            // avoid recursive updating by ignoring the box's changed event          box.PasswordChanged -= HandlePasswordChanged;
