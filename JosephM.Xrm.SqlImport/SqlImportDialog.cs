...
{
    [RequiresConnection]
    public class SqlImportDialog :
        ServiceRequestDialog
            <SqlImportService, SqlImportRequest,
                SqlImportResponse, SqlImportResponseItem>
    {
        public SqlImportDialog(SqlImportService service,
            IDialogController dialogController, XrmRecordService lookupService)
            : base(service, dialogController, lookupService, nextButtonLabel: "Import")
        {
            SetTabLabel("Import SQL");
            var validationDialog = new SqlImportValidationDialog(this, Request);
