...
{
    [RequiresConnection]
    public partial class ManagePluginTriggersDialog : DialogViewModel
    {
        ...
        {
            var response = new ManagePluginTriggersResponse();
            try
            {
