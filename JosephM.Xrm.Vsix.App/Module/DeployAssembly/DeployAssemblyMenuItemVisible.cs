...
{
    public class DeployAssemblyMenuItemVisible : MenuItemVisible
    {
        public override bool IsVisible(IApplicationController applicationController)
        {
            ...
            if (selectedItems.Count() == 1)
            {
                ...
                {
                    if (packageSettings.PluginProjects.Any(p => p.ProjectName == selectedItem.Name && !p.DisableAssemblyDeploy))
                        return true;
                }
            }
            return false;
