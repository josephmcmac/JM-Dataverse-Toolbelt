...
namespace JosephM.Xrm.CustomisationExporter
{
    public class RelationshipExport
    {
        public RelationshipExport(string relationshipSchemaName, string recordTypeFrom, string recordTypeTo, bool isCustomRelationship
            , bool displayRelated, bool displayRelated2, string recordType1ReferenceField, string recordType2ReferenceField, RelationshipType type, bool recordType1UseCustomLabel, bool recordType2UseCustomLabel, string recordType1CustomLabel, string recordType2CustomLabel, int recordType1DisplayOrder, int recordType2DisplayOrder)
        {
