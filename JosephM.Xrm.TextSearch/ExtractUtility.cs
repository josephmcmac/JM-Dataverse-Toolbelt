    ...
    public static class ExtractUtility
    {
        ...
        public static IEnumerable<string> GetSystemRecordTypesToExclude()
        {
            return new[]
            {
                ...
                Entities.msdyn_nonrelationalds, Entities.datalakeworkspace, Entities.datalakeworkspacepermission, Entities.msdyn_casesuggestion, Entities.msdyn_knowledgearticlesuggestion, Entities.virtualresourcegroupresource, Entities.msdyn_solutioncomponentcountsummary, Entities.msdyn_solutioncomponentcountdatasource, Entities.msdyn_suggestedactivity, Entities.msdyn_suggestedcontact, "aaduser", "msdyn_connectordatasource", "componentversion", "componentversionnrddatasource"
            };
        }
